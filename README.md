...
키보드 아이콘을 클릭하고 원하는 키/조합을 차례로 누른 뒤 체크 아이콘을 클릭합니다.
...
Auto Pilking 기본값은 우클릭 1.0초 누름/3.5초 해제이며, 각 시간은 0.1초 단위로 조절합니다.
Auto Pilking과 Double Click to Holding은 RF4 본체 창이 전면에 있을 때만 입력을 수행합니다.
다른 앱으로 전환하면 실행 상태를 유지한 채 입력을 멈추고, RF4로 돌아오면 자동으로 재개합니다.
